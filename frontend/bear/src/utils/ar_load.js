export default {
  ...
  created() {
    letsee.ready(() => {
      ...
      //   });
      letsee //클라우드 생 드라프트
        .addTarget("https://developer.letsee.io/api-tm/target-manager/target-uid/611488b256197305fc5c131f")
        .then((entity) => {
          let div = this.$refs.con;
          div.style.width = 360 + "px";
          div.style.height = 640 + "px";
      ...
      letsee //스텔라
        .addTarget("https://developer.letsee.io/api-tm/target-manager/target-uid/611488a056197305fc5c131e")
        .then((entity) => {
          let div = this.$refs.con;
          div.style.width = 360 + "px";
          div.style.height = 640 + "px";
