        ...
        created() {
          letsee.ready(() => {
            ...
            //   });
              letsee //클라우드 생 드라프트
              .addTarget(
                "https://developer.letsee.io/api-tm/target-manager/target-uid/611d1bb73f9ee405ea644b2d"
              )
              .then((entity) => {
                let div = this.$refs.con;
                div.style.width = 360 + "px";
              ...
              letsee //스텔라 
              .addTarget(
                "https://developer.letsee.io/api-tm/target-manager/target-uid/611d1bc056197305fc5c1323"
              )
              .then((entity) => {
                let div = this.$refs.con;
                div.style.width = 360 + "px";
